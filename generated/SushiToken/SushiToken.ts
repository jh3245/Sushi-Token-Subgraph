...
export class SushiToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiToken extends ethereum.SmartContract {
  static bind(address: Address): SushiToken {
    return new SushiToken("SushiToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): SushiToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new SushiToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SushiToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SushiToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
